...
<head>
    ...
    <title>Administrator Profile | OXXA GEAR Control Center</title>
                ...
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h1 class="d-flex align-items-center gap-2 mb-0" style="font-size: 1.35rem; font-weight: 900; color: #0F172A; letter-spacing: -0.025em; line-height: 1.2;">
                            ...
                            <span style="font-size: 0.65rem; font-weight: 800; padding: 3px 8px; border-radius: 9999px; background: #DBEAFE; color: #1E40AF; letter-spacing: 0.05em; text-transform: uppercase;">Security & Credentials</span>
                        </h1>
                        <p class="mb-0" style="color: #64748B; font-size: 0.78rem; font-weight: 500; margin-top: 2px;">Manage executive credentials, contact details, authentication security & preferences.</p>
                    </div>
                </div>
            </div>
