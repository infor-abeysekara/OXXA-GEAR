...
<div class="bg-gray-50 min-h-screen py-10 mt-20">
    <div class="container mx-auto px-4 max-w-6xl">
        ...
        <div class="flex items-center text-sm text-gray-500 mb-6">
            ...
            <span class="text-navy font-bold">Address Book</span>
        </div>
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="flex-1">
                <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden p-8 md:p-10 text-center flex flex-col items-center justify-center min-h-[400px]">
                    ...
                    <button class="px-8 py-3 bg-[#0066FF] text-white font-bold rounded-full uppercase tracking-wide hover:bg-blue-700 transition-colors shadow-lg shadow-blue-500/30">
