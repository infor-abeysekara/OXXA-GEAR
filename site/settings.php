                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden sticky top-24">
                    ...
                    <div class="p-3 flex flex-col gap-1">
                        ...
                        <a href="wishlist.php" class="flex items-center px-4 py-3 rounded-xl font-bold text-sm text-gray-600 hover:bg-gray-50 hover:text-[#0066FF] transition-colors">
                            <i class="far fa-heart w-6 text-lg"></i> Settings
                        </a>
            ...
            <div class="flex-1">
                <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden p-8 md:p-10 text-center flex flex-col items-center justify-center min-h-[400px]">
                    <div class="w-24 h-24 bg-blue-50 rounded-full flex items-center justify-center mb-6">
                        <i class="fas fa-cog text-[#0066FF] text-4xl"></i>
                    </div>
                    <h2 class="text-2xl font-black text-navy uppercase tracking-wide mb-2">Settings</h2>
                    <p class="text-gray-500 mb-8 max-w-md mx-auto">Manage your account preferences and settings.</p>
                    <a href="profile.php" class="px-8 py-3 bg-[#0066FF] text-white font-bold rounded-full uppercase tracking-wide hover:bg-blue-700 transition-colors shadow-lg shadow-blue-500/30">Back to Profile</a>
                </div>
            </div>
        </div>
    </div>
