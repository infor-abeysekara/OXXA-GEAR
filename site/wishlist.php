        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="flex-1">
                <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden p-8 md:p-10 text-center flex flex-col items-center justify-center min-h-[400px]">
                    ...
                    <a href="products.php" class="px-8 py-3 bg-[#0066FF] text-white font-bold rounded-full uppercase tracking-wide hover:bg-blue-700 transition-colors shadow-lg shadow-blue-500/30">
                        Continue Shopping
                    </a>
                </div>
            </div>
